...
const MeetThePoint = () => {
  return (
    <div className="md:w-[1176px] mx-auto md:flex justify-center items-center gap-x-32 p-5 md:p-0">
      <div className="md:w-[500px]">
        <h4 className="text-[#6B63FF] font-semibold mb-3">MEET THE POINT</h4>
        <h2 className="flex items-center gap-3 md:text-4xl mb-10 font-bold">
          Align{" "}
        ...
        <button className="px-5 py-3 bg-[#3E66F8] block mt-5 mb-10 md:mb-0 text-white rounded-lg">
          Get Started
        </button>
      </div>
      <div className="h-[700px] md:h-[600px] md:w-[555px] rounded-3xl bg-[#EEF9FF] relative">
        <div className=" bg-white w-[280px] md:w-[350px] p-8 rounded-lg absolute bottom-3 md:bottom-16 right-5 md:right-16 z-10">
        ...
        <div className="bg-white w-[220px] md:w-[300px] p-5 absolute shadow-xl top-52 md:top-24 md:-left-16 z-20">
        ...
        <IoStar className="absolute text-8xl text-yellow-300 right-32 md:right-44 top-8"></IoStar>
      </div>
    </div>
  );
};
